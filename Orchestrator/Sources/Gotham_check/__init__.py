...
def check_tags(object_type, objects_infos, tags_hp='', tags_serv='', mode=False):
    ...
    # mode (bool) : true for an exact research (there is no other tags), false in the other case (it can has other tags)
    #
...
def check_servers_ports_matching(servs_infos, ports):
    ...
    # ports (string) : ports we want to check for
    #
    # Return the list of available ports presents in the list of given ports with server information concatenated
