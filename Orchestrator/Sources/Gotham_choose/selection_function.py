...
def weighting_nb_port(servs_infos):
    ...
    # 
    # Return list of dict of serv with additional weight based on the number of port used
...
def weighting_nb_useless_tags(object_type, objects_infos, tags):
    ...
    # 
    # Return list of dict of object with additional weight based on the useless tag number
...
def weighting_nb_free_port(servs_infos):
    # Add a weight corresponding to the number of free port associated with each server 
    #
    #
    # servs_infos (list of dict) : list of potentials servs
    # 
    # Return list of dict of server with additional weight based on the free port number
    ...
    # Apply weight for each server according to its number of free port for the link 
...
def weighting_time(object_type, objects_infos, column):
    ...
    # 
    # Return list of dict of object with additional weight based on the creation and modification timestamp
    ...
    # Apply weight for each object according to its creation or modification timestamp 
