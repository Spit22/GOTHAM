...
recordings = {'id':'sv-62323F6F323F38F42d656DF86466666F','name':'serveur-test-6','descr':'blabla','tags':'Europe,France,SSH,TestTag,TagDeTest4TesTag666','ip':'98.254.99.99','ssh_key':'non','ssh_port':'22','state':'ERROR'}
honeypot_infos = {"id":"hp-1F5B3AFE32EE71EFB1D25EFFFC2CA69F", 'name':'hp-test-6','tags':'TestTag22,TesTag666,TagDeTest42', 'port':22,'parser':'TO_ADD','logs':'TO_ADD','source':"TO_ADD", "id_container":"FABC12345678",'state':'UNUSED'}
##########-SETTINGS-##########
