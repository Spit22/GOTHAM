...
from Gotham_check import check_used_port, check_ssh, check_doublon_tags,check_servers_ports_matching
import mariadb
...
try:
    print(colored("########## Get Server Infos with id (false mode) ##########", 'yellow'))
    print(get_server_infos(DB_settings, id="sv-88784AF833CD11EBAEA003EBFB2CA371"))
except:
    print(colored('[X] get_server_infos failed', 'red'))
'''
'''
